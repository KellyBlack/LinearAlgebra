\documentclass[fleqn,svgnames,table,,aspectratio=169]{beamer}
...
\title{Section 5.5: Complex Numbers}
\subtitle{Who Could Have Imagined?}
...
\begin{frame}{Goals}
  ...
  \begin{itemize}
  \item Use the definition of $\sqrt{-1}$ to express all of the roots
    of a polynomial as a complex number.
  \item Perform basic arithmetic operations on complex numbers.
  \end{itemize}
...
\begin{frame}{Complex Numbers}
  ...
  \begin{block}{Definition: $i$}
    The number $i$ is defined to be $\sqrt{-1}$.
  \end{block}

  \begin{block}{Definition: Imaginary Number}
    An imaginary number is any real number multiplied by $i$.
  \end{block}

  \begin{block}{Definition: Complex Number}
...
\begin{frame}{Ways To Express A Complex Number}

  \begin{itemize}
  \item Cartesian Form (Rectangular)
    \begin{eqnarray*}
      a + b\cdot i.
    \end{eqnarray*}
  \item Polar Form
...
\begin{frame}{Arithmetic}
  ...
  \begin{flalign*}
    ...
    (a+b\cdot i) \cdot (a - b\cdot i) & =  \\
    \frac{(a+b\cdot i)}{(c + d\cdot i)} & =  
  \end{flalign*}
...
\begin{frame}{The Complex Conjugate}
  ...
  \begin{block}{Definition: The Complex Conjugate}
    The complex conjugate of a complex number is determined by
    multiplying the imaginary part of the number by -1.
  \end{block}

  \begin{block}{Notation: The Complex Conjugate}
    If $z=a+b\cdot i$ the complex conjugate is denoted as
    \begin{eqnarray*}
      \bar{z} & = & a - b\cdot i.
    \end{eqnarray*}
  \end{block}
...
\begin{frame}{Example: The Complex Conjugate}

  If $z_1=4+2i$ the complex conjugate is
  \begin{eqnarray*}
    \bar{z}_1 & = & 4 - 2i.
  \end{eqnarray*}

  If $z_2=8-3i$ the complex conjugate is
  \begin{eqnarray*}
    \bar{z}_2 & = & 8 + 3i.
  \end{eqnarray*}
